...
var _default = { data: function data() {return { imgUrl: 'http://106.15.194.58/images/', //图片接口
      curHdIndex: '0', orderId: '', orderList: [], type: 2 // orderList:[]
    };}, onShow: function onShow() {_public.default.delOrderType = true;}, onLoad: function onLoad(e) {this.getOrderList(1);}, methods: { tabFun: function tabFun(index) {//切换tab
      this.curHdIndex = index - 1;this.getOrderList(index); //请求数据，替换orderList
      //	this.orderList = [];
    }, waitingMeal: function waitingMeal(type, orderId) {//跳待取餐
      uni.navigateTo({ url: '../waitingMeal/waitingMeal?id=' + orderId + '&type=' + this.type, animationType: 'slide-in-right', animationDuration: 200 });}, /**
                                                                                                                                                              * 获取订单列表
                                                                                                                                                              * type: number -1 取消的 0-待提交的 1-待接收 2-待取餐 3-待评价 4-已评价
                                                                                                                                                              */getOrderList: function getOrderList(index) {var _this = this;var type = '';switch (index) {case 1:type = 2;break;case 2:type = 3;break;case 3:type = 4;break;case 4:type = 0;break;}uni.showLoading({
        mask: true });
